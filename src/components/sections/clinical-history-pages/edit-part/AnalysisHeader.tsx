...
import { makeStyles, tokens, Button, Link, Title1, Text } from '@fluentui/react-components';
        ...
        <div className={styles.titleRow}>
          <div className={styles.titleLeft}>
            ...
            <div className={styles.titleContainer}>
              <Title1 className={styles.titleText}>Edit Riwayat Klinis</Title1>
              <Text className={styles.subtitleText}>
                Lakukan penyesuaian pada data klinis pasien untuk menghasilkan prediksi risiko FGR yang diperbarui.
              </Text>
            </div>
          </div>
        </div>
