        ...
        try {
          ...
          if (json.success && json.data.patient && json.data.assessment) {
            ...
            setFormData(prev => ({
              ...
              mage: mage,
              meduc_raw: a.meduc || 1,
              meduc_cat: getEducationCat(a.meduc || 1),
              racemom: String(a.racemom || ''),
              hispmom: a.hispmom === 1 ? 'Y' : 'N',
              marital: String(a.marital || ''),
              fage: String(a.fage || ''),
              feduc_raw: a.feduc || 1,
              feduc_cat: getEducationCat(a.feduc || 1),
              racedad: String(a.racedad || ''),
              hispdad: a.hispdad === 1 ? 'Y' : 'N',

              anemia: a.anemia === 1,
              jantung: a.jantung === 1,
              paru: a.paru === 1,
              diabetes: a.diabetes === 1,
              hipertensi_kronis: a.hipertensi_kronis === 1,
              hipertensi_gestasional: a.hipertensi_gestasional === 1,
